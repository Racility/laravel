...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet"/>
   ...
   <div class="mt-5 w-50">
    ...
    <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="curretImage" class="form-label" style="display: block">Current Image</label>
            @if ($book->cover!='')
                <img src="{{ asset('storage/cover/'.$book->cover) }}" alt="" width="100px">
                @else
                <img src="{{ asset('images/Cover-Not-Found.jpg') }}" alt="" width="100px">
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            <ul>@foreach ($book->categories as $category)
                <li>{{ $category->name }}</li>
            @endforeach</ul>
        </div>
